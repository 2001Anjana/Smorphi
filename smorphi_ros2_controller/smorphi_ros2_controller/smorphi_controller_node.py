...
from std_msgs.msg import Int32  # moved to top-level (do not import inside class)
...
class SmorphiController(Node):
    ...
    def imucallback(self, msg):
        ...
        self.imu_msg = msg
        if self.imu_flag == 0:
            (self.roll, self.pitch, self.prev_yaw) = tf_transformations.euler_from_quaternion(
